...
total_minutes = holidays_in_minutes + working_days_in_minutes  # Да го променя на английски език!!!

diff = abs(norm_of_play - total_minutes) # Да го променя на английски език!!!

h = diff // 60
m = diff % 60

if norm_of_play >= total_minutes: # Да го променя на английски език!!!
