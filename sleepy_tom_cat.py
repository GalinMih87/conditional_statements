...
norm__of_play = 30000 # Да го променя на английски език!!!
...
diff = abs(norm__of_play - obshto_minuti) # Да го променя на английски език!!!

h = diff // 60
m = diff % 60

if norm__of_play >= obshto_minuti: # Да го променя на английски език!!!
    print(f"Tom sleeps well")
    print(f"{h} hours and {m} minutes less for play")
elif norm__of_play <= obshto_minuti:
